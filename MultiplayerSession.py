...
class MultiplayerSession(threading.Thread):
    ...
    def startMultiplayerSession(self, conn1, conn2):
        ...
        print(conn1ID)
        print(conn2ID)
        playerOneUsername = self.dbm.getUsernameFromPlayerID(str(conn1ID))
        playerTwoUsername = self.dbm.getUsernameFromPlayerID(str(conn2ID))
        ...
        if conn1wins == 2:
            ...
            print(self.dbm.updateScore([conn1ID, winnerScore, conn2ID, loserScore]))
            ...
            print(self.dbm.updateScore([conn2ID, winnerScore, conn1ID, loserScore]))
            self.messenger.addIpAddress(self.player1Address[0])
            self.messenger.addIpAddress(self.player2Address[0])