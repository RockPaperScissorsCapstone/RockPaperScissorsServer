...
class session:
    ...
    def startSession(self, conn):
        ...
        while True:
            dbm = DBManager()
            playerMove = 0
            print("About to receive player ID")
            pID = conn.recv(1024)
            print("About to receive player move")
